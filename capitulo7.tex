...
\begin{marginfigure}
  ...
  \begin{tikzpicture}[scale=1]
    ...
    % % ============ SEÑALES A y B ============
    % \node[font=\footnotesize\bfseries, blue!80!black] at (4.0,-2.7) {A};
    % \draw[blue!70!black, thick]
    %   (4.3,-2.6) -- (4.5,-2.6) -- (4.5,-3.0) -- (4.7,-3.0) -- (4.7,-2.6)
    %   -- (4.9,-2.6) -- (4.9,-3.0) -- (5.1,-3.0) -- (5.1,-2.6)
    %   -- (5.3,-2.6) -- (5.3,-3.0) -- (5.5,-3.0) -- (5.5,-2.6) -- (5.7,-2.6);

    % \node[font=\footnotesize\bfseries, green!60!black] at (4.0,-3.3) {B};
    % \draw[green!60!black, thick]
    %   (4.3,-3.6) -- (4.4,-3.6) -- (4.4,-3.2) -- (4.6,-3.2) -- (4.6,-3.6)
    %   -- (4.8,-3.6) -- (4.8,-3.2) -- (5.0,-3.2) -- (5.0,-3.6)
    %   -- (5.2,-3.6) -- (5.2,-3.2) -- (5.4,-3.2) -- (5.4,-3.6) -- (5.7,-3.6);
    \end{scope}    
...
%% ============ VISTA LATERAL ============
  ...
  \caption[Encoders ópticos incremental y absoluto.]{%
    Comparativa de encoders ópticos. \textbf{izquierda}: el encoder \emph{incremental} genera señales en cuadratura A y B para determinar velocidad y sentido. \textbf{derecha}: el encoder \emph{absoluto} utiliza pistas concéntricas codificadas (ej. código Gray) para identificar la posición angular exacta de forma unívoca y permanente.}\label{fig:encoder}
\end{marginfigure}
