...
\]
donde $u_i$ es la incertidumbre de cada variable de entrada $x_i$. En términos generales, si se tiene una función $f(x_1, x_2, ..., x_n)$ que depende de varias variables de entrada $x_i$, la incertidumbre de la variable de salida $y$ se calcula como:
\[
