...
\begin{marginfigure}
    ...
    \begin{tikzpicture}[scale=0.7]
        ...
        \node[orange!70!black, font=\tiny] at (0,-1.1) {ANILLO DE GUARDA ($V_{sig}$)};
        
        % Masa exterior
        \draw[fill=green!10, even odd rule] (-2,-2) rectangle (2,2) (0,0) circle (1.2);
        \node[green!50!black, font=\tiny] at (1.5, 1.5) {PLANO MASA};
    \end{tikzpicture}
    \caption{Diseño de un anillo de guarda en PCB. El anillo actúa como una barrera de potencial que intercepta corrientes de fuga y neutraliza capacidades parásitas laterales.}\label{fig:anillo_guarda}
\end{marginfigure}
