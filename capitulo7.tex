...
\begin{marginfigure}
    ...
    \begin{tikzpicture}[scale=1, >=stealth]
        ...
        \tikzset{
            cuerpo/.style={fill=black!85, draw=black},
            objeto/.style={fill=orange!40, draw=black!80, thick},
            haz/.style={red, dashed, thick},
            reflector/.style={fill=cyan!20, draw=cyan!80!black, thick}
        }

        % --- TIPO 1: BARRERA (THROUGH-BEAM) ---
        \begin{scope}[yshift=4cm,scale=1.2]
            \node[anchor=west, font=\tiny] at (0, 1.8) {BARRERA};
            % Emisor
            \draw[cuerpo] (0,1) rectangle (0.4,1.5) node[midway, white, font=\tiny] {E};
            % Receptor
            \draw[cuerpo] (2.6,1) rectangle (3,1.5) node[midway, white, font=\tiny] {R};
            % Haz
            \draw[haz] (0.4, 1.25) -- (2.6, 1.25);
            % Objeto
            \draw[objeto] (1.3, 0.8) rectangle (1.7, 1.7) node[midway, font=\tiny, rotate=90] {OBJETO};
        \end{scope}

        % --- TIPO 2: RÉFLEX ---
        \begin{scope}[yshift=2cm,scale=1.2]
            \node[anchor=west, font=\tiny] at (0, 1.8) {RÉFLEX};
            % Cuerpo combinado
            \draw[cuerpo] (0,1) rectangle (0.4,1.5) node[midway, white, font=\tiny] {E/R};
        ...
        \begin{scope}[yshift=0cm,scale=1.2]
            \node[anchor=west, font=\tiny] at (0, 1.8) {DIFUSO};
            % Cuerpo combinado
            \draw[cuerpo] (0,1) rectangle (0.4,1.5) node[midway, white, font=\tiny] {E/R};
            % Objeto (hace de reflector)
            \draw[objeto] (1.8, 0.8) rectangle (2.2, 1.7) node[midway, font=\tiny, rotate=90] {OBJETO};
