...
\begin{table}[ht]
    \centering
    \caption[Características de los termopares estándar según IEC.]{Características de los termopares estándar según IEC. Los valores de sensibilidad son promedios en sus rangos lineales.}\label{tab:tipos_termopares}
...
\begin{table}[ht]
    ...
    \caption[Comparativa de sensores generadores.]{Comparativa de sensores generadores. Nótese la diversidad de señales de salida (tensión, carga o corriente), lo que exige etapas de acondicionamiento específicas para cada tecnología.}\label{tab:resumen_generadores}
