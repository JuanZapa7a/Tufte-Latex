...
Los \emph{sensores GMR} (Giant Magnetoresistance) alcanzan variaciones de hasta el \qty{80}{\%} mediante multicapas cuánticas ferromagnético/antiferro\-magnético (Fe/Cr). Son la base de los cabezales de lectura de discos duros y de los sensores de ángulo en los codificadores de precisión. La Tabla~\ref{tab:hall_vs_mr} resume las características de estos tres tipos de sensores para aplicaciones de instrumentación magnética.   
