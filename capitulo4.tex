...
\begin{table}[ht]
    \centering
    \caption[Especificaciones típicas de sensores de corrientes de Foucault.]{Especificaciones típicas de los sensores de corrientes de Foucault industriales (familia Micro-Epsilon eddyNCDT).}\label{tab:eddy_specs}
...
\begin{table}[!ht]
    \centering
    \caption[Comparativa general de tecnologías reactivas.]{Comparativa general de tecnologías reactivas. Se resaltan las ventajas y limitaciones de cada tecnología. Destacamos que la elección dependerá de la precisión requerida y las condiciones ambientales.}\label{tab:comparativa_final}
...
\begin{table}[!ht]
    \centering
    \caption[Clasificación y mitigación de errores en sistemas de medida reactivos.]{Clasificación y mitigación de errores en sistemas de medida reactivos.}\label{tab:resumen_errores_reactivos}
