...
\end{equation}
donde $d$ es la distancia entre el sensor y el condensador de realimentación, q es la carga generada por el sensor, $C_f$ es la capacidad del condensador de realimentación y $F$ es la fuerza aplicada.
