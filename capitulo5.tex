...
El hecho de no usar inductores es una gran ventaja, ya que los inductores son voluminosos, caros y pueden introducir pérdidas y no linealidades. Antes de ver el filtro activo, conviene comparar con un filtro pasivo convencional de segundo orden que sí utiliza inductores.
...
\begin{marginfigure}
    ...
    \end{tikzpicture}
    \caption{Filtro pasivo RLC paso bajo convencional.}
    \label{fig:filtro_pasivo_rlc}
\end{marginfigure}

Este filtro utiliza una resistencia, una inductancia y una capacitancia para obtener una respuesta de segundo orden con frecuencia de corte $\omega_0 = 1/\sqrt{LC}$, pero requiere un inductor y no puede proveer ganancia.
