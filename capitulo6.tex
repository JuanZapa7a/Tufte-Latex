...
\begin{marginfigure}
    ...
    \begin{tikzpicture}[american, scale=1]
        ...
        \node[red, font=\tiny, align=center] at (2, 2) {Tierra\\Virtual};
...
\begin{marginfigure}[0em]
    ...
    \begin{tikzpicture}[scale=1]
        % Unión PN
        \draw[fill=red!15] (0,0.5) rectangle (3,1); \node[red!70!black, font=\tiny] at (2.8,0.85) {Capa P};
        \draw[fill=blue!15] (0,0) rectangle (3,0.5); \node[blue!70!black, font=\tiny] at (0.3,0.15) {Capa N};
        ...
        \node[font=\tiny, align=center] at (0.35, 0.5) {Pares\\$e^-/h^+$};
...
\begin{marginfigure}
    ...
    \begin{tikzpicture}[american, scale=0.95]
        ...
        \begin{scope}[xshift=-1.7cm]
            ...
            % Salida
            \draw (2.2, 0.3) -- (2.2, -0.4) node[ocirc, scale=0.6] {} node[below, font=\tiny] {$V_{out} \propto \vec{v}(t)$};
        ...
        \begin{scope}[ xshift=1.5cm]
            ...
            \node[font=\tiny, gray] at (1.25, 3.7) {Carcasa (Unida al suelo)};

            % Imán central (Fijo a la carcasa)
            \draw[fill=red!20] (0.9, 1.2) rectangle (1.6, 1.9);
            \draw[fill=blue!20] (0.9, 0.5) rectangle (1.6, 1.2);
            \node[red, font=\tiny] at (1.25, 1.55) {N};
            \node[blue, font=\tiny] at (1.25, 0.85) {S};

            % Bobina (Suspendida)
            \draw[ultra thick, orange!80!black] (0.6, 0.8) rectangle (1.9, 2.3);
            \node[orange!80!black, font=\tiny, rotate=90] at (0.4, 1.55) {Bobina (Masa)};
            ...
            \node[blue!60, font=\tiny] at (1.6, 3) {$k$};
            
            % Vibración
            \draw[<->, thick, gray] (1.25, -0.4) -- (1.25, -1) node[below, font=\tiny] {Vibración};
